...
export default function LullabyPage() {
  ...
  if (!currentTrack) {
    return (
      <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center text-gray-200 p-4">
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center font-sans p-4 text-white">
