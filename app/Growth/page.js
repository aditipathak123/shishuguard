  ...
  return (
    <div className="relative">
      <div
        ...
        <CalendarIcon className="w-5 h-5 text-cyan-400 dark:text-cyan-300" />
      </div>
        ...
        <div className="absolute top-full left-0 z-50 mt-1 bg-white dark:bg-gray-800 border rounded-lg shadow-lg p-4 min-w-[280px]">
          ...
          <div className="grid grid-cols-7 gap-1 mb-2">
            {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
              <div key={day} className="text-center text-sm font-bold text-pink-300 py-2">
                {day}
              </div>
            ))}
          </div>
              ...
              <div key={index} className="text-center">
                {day && (
                  <button
                   ...
                   className={`w-9 h-9 text-sm rounded-xl hover:bg-cyan-500/20 hover:text-cyan-300 transition-all duration-300 ${
    ...
    : "text-cyan-200 dark:text-white"
          ...
          <div className="mt-4 pt-3 border-t flex justify-between">
            <button
              ...
              className="text-sm font-bold text-cyan-400 hover:text-pink-400 transition-all duration-300"
              type="button">
              Today
            </button>
            <button onClick={() => setIsOpen(false)} className="text-sm font-bold text-pink-300 hover:text-cyan-300 transition-all duration-300" type="button">
              Cancel
            </button>
          </div>
        </div>
...
export default function GrowthPage() {
  ...
  useEffect(() => {
    document.title = "Growth |  ShishuGuard";
  }, []);
    ...
    <div className="container max-w-6xl mx-auto px-4 sm:px-6 space-y-6  dark:bg-gray-800/90">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow dark:bg-gray-700/90">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
           <label className="block text-sm font-bold mb-2 bg-gradient-to-r from-cyan-400 via-blue-400 to-pink-400 bg-clip-text text-transparent tracking-wide animate-pulse">
  Date of Birth
</label>
            <DatePicker className="dark:bg-gray-800/90" placeholder="Select date of birth" value={babyDOB} onChange={(date) => setBabyDOB(date)} />
          </div>
          <div>
            <label className="block text-sm font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-pink-400 bg-clip-text text-transparent tracking-wide animate-pulse mb-2">
  Gender
</label>
            <select
              value={babyGender}
  ...
  Comment
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-[#0f172a] via-[#111827] to-black border border-cyan-500/20 rounded-3xl p-6 shadow-2xl space-y-4">
          <InteractionWithBaby />
        </div>
      </div>
      {hasBadge && (
      ...
      <div className="text-center text-lg font-bold py-10 animate-pulse bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">
        For more information regarding this section, visit{" "}
        <a href="/Resources" className="font-black text-cyan-400 hover:text-pink-400 transition-all duration-300 hover:underline">
          Resources
        </a>{" "}
        or{" "}
       <a href="/Faqs" className="font-black text-purple-400 hover:text-cyan-400 transition-all duration-300 hover:underline">
          FAQs
        </a>
        .
      </div>
