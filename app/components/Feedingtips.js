  ...
  return (
    <section id="feeding-tips" className="px-4 py-6 bg-white/50 dark:bg-gray-700 rounded-lg space-y-12">
      ...
      <div className="mt-2 flex justify-center">
        <div className="inline-flex flex-col items-center gap-3 rounded-2xl border border-pink-200 bg-white/90 px-5 py-4 text-center shadow-[0_12px_35px_rgba(236,72,153,0.18)] backdrop-blur-sm dark:border-cyan-300/40 dark:bg-gray-900/90 dark:shadow-[0_0_32px_rgba(34,211,238,0.18)] sm:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <Link
              href="/Resources"
              className="rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-4 py-2 text-sm font-black text-white shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:shadow-lg"
            >
              Resources
            </Link>
            <Link
              href="/Faqs"
              className="rounded-full border border-cyan-300 bg-cyan-50 px-4 py-2 text-sm font-black text-cyan-700 shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:bg-cyan-100 dark:bg-cyan-950 dark:text-cyan-100"
            >
              FAQs
            </Link>
          </div>
